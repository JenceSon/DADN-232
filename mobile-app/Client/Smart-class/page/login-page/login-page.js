...
import {Image, View, Text, TextInput, ScrollView, TouchableOpacity, Modal} from "react-native";
            ...
            <View>
                {
                    ...
                    (<Modal>
                        <View className="flex flex-1 justify-center items-center">
                            <LottieView source={require("../../assets/loading_anim.json")} autoPlay loop
                ...
                <View style={loginStyles.container2}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={async () => {
                            setFetchData(true);
                            const login_rs = await CheckLogin({bkid: form.bkid, password: form.password});
                            setTimeout(() => {
                                setFetchData(false);
                            }, 500)
                            if (!login_rs.id) {
